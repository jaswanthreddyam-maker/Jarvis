...
from jarvis.infrastructure.system_control.window_control import _find_window, close_window, focus_window


APP_ALIASES: dict[str, dict[str, str]] = {
    "chrome": {"command": "chrome", "process": "chrome.exe", "window": "chrome"},
    "google_chrome": {"command": "chrome", "process": "chrome.exe", "window": "chrome"},
    "comet": {"command": "chrome", "process": "chrome.exe", "window": "comet"},
    "edge": {"command": "msedge", "process": "msedge.exe", "window": "edge"},
    "microsoft_edge": {"command": "msedge", "process": "msedge.exe", "window": "edge"},
    ...
    "windows_terminal": {"command": "wt", "process": "WindowsTerminal.exe", "window": "terminal"},
    "cmd": {"command": "cmd", "process": "cmd.exe", "window": "command prompt"},
    "command_prompt": {"command": "cmd", "process": "cmd.exe", "window": "command prompt"},
    ...
    "file_explorer": {"command": "explorer", "process": "explorer.exe", "window": "file explorer"},
}
...
def _resolve_alias(name: str) -> dict[str, str]:
    ...
    return APP_ALIASES.get(normalized, {"command": str(name).strip(), "process": "", "window": normalized.replace("_", " ")})
